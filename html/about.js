...
if (!YOASOBI) {
    OASOBI = new APlayer({
        ...
        audio: [{
            url: 'https://music.163.com/song/media/outer/url?id=1838505400.mp3',
            cover:  'http://p1.music.126.net/fSLTPArWnHVdFDIIiBJ3rA==/109951165904744434.jpg?param=130y130',
            mode: 'mini',
            preload: 'none',
        }]
    })
...
if (!TUYU) {
    TUYU = new APlayer({
        ...
        audio: [{
            url: 'https://music.163.com/song/media/outer/url?id=2021543605.mp3',
            cover: 'http://p1.music.126.net/4U6GPwZZdXs4LNGWDjwEyQ==/109951168300999675.jpg?param=130y130',
            mode: 'mini',
            preload: 'none',
        }]
    })
...
if (!PJSK) {
    PJSK = new APlayer({
        ...
        audio: [{
            url: 'https://music.163.com/song/media/outer/url?id=1879098277.mp3',
            cover: 'https://is2-ssl.mzstatic.com/image/thumb/Music125/v4/20/ec/11/20ec11e5-639d-42d5-fa58-879dec1eca4b/859750397874_cover.jpg/592x592bb.webp',
            mode: 'mini',
            preload: 'none',
        }]
    })
